...
public partial class GetCode
{
    ...
    static int Main(string[] args)
    {
        ...
        string code = System.IO.File.ReadAllText(SfilePath, Encoding.UTF8).Replace("\r\n", "").Replace("\r", "").Replace("\n", "") + System.IO.File.ReadAllText(MfilePath, Encoding.UTF8).Replace("\r\n", "").Replace("\r", "").Replace("\n", "") + System.IO.File.ReadAllText(IfilePath, Encoding.UTF8).Replace("\r\n", "").Replace("\r", "").Replace("\n", "") + System.IO.File.ReadAllText(OfilePath, Encoding.UTF8).Replace("\r\n", "").Replace("\r", "").Replace("\n", "") + System.IO.File.ReadAllText(TfilePath, Encoding.UTF8).Replace("\r\n", "").Replace("\r", "").Replace("\n", "");
